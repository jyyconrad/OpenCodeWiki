    ...
    def create_agent(self, module_name: str, components: Dict[str, Any],
        ...
        if is_complex_module(components, core_component_ids):
            return Agent(
                ...
                system_prompt=format_system_prompt(module_name, self.custom_instructions, language=self.config.output_language),
            )
        else:
            return Agent(
                self.fallback_models,
                ...
                system_prompt=format_leaf_system_prompt(module_name, self.custom_instructions, language=self.config.output_language),
            )
