...
Generate all documentation content in {language}. Ensure technical terms are accurately translated or kept in English where appropriate.
</LANGUAGE_REQUIREMENT>
...
def format_system_prompt(module_name: str, custom_instructions: str = None, language: str = "zh-CN") -> str:
    """
    ...
    Args:
        ...
        language: Output language for documentation (default: zh-CN)
    ...
    return SYSTEM_PROMPT.format(module_name=module_name, custom_instructions=custom_section, language=language).strip()


def format_leaf_system_prompt(module_name: str, custom_instructions: str = None, language: str = "zh-CN") -> str:
    """
    ...
    return LEAF_SYSTEM_PROMPT.format(module_name=module_name, custom_instructions=custom_section, language=language).strip()